...
//     http://fsharp.org
//     https://docs.microsoft.com/tr-tr/dotnet/articles/fsharp/
//
//Bu öğreticiyi belge biçiminde görmek için, bkz:
//     https://docs.microsoft.com/tr-tr/dotnet/articles/fsharp/tour
//
...
module Immutability =
    ...
    //
    // '=' işaretinin bununla aynı olmadığına dikkat edin. '=' eşitliği test etmek için kullanılır.
...
///     https://docs.microsoft.com/tr-tr/dotnet/articles/fsharp/language-reference/primitive-types
///     ve
///     https://docs.microsoft.com/tr-tr/dotnet/articles/fsharp/language-reference/symbol-and-operator-reference/boolean-operators
module Booleans =
...
module PipelinesAndComposition =
    ...
    /// ve her bir veri işleme işleminin giriş ve çıkış türleri kullandığımız işlevlerin imzaları ile eşleştiği için
    /// mümkün olmaktadır.
...
///
/// Lists'e benzer olsalar da (numaralandırmayı desteklerler ve veri işleme için benzer birleştiricilere sahiptirler)
...
module Sequences = 
    ...
    /// Bu, 1'den 100'e kadar olan isteğe bağlı bir seridir.
...
/// 'let rec' kullanılarak bildirildiğinde.
///
